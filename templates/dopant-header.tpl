(define-param linput 6)                    ; length of input waveguide
...
(define-param loutput 6)                        ; length of output waveguide
(define-param woutput 0.6)                      ; width of output waveguide
(define-param wairbound 1)                    ; air surrounding the PIC in Y direction
;(define-param wgraphene 3.0)              ; width of graphene sheet
;(define-param lgraphene 3)                ; length of graphene sheet
...
(define-param sz (+ wairbound hsilicon wairbound)) ; size of structure cell in Z
